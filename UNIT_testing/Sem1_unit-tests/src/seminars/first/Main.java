...
//        String[] colors = {"aqua", "green", "yellow", "blue", "orange", "violet", "gold"};
//
//        testingJavaCollectionsAssertJ(colors);
    ...
    public static void happyNY() {
        ...
        DateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy"); //  HH:mm:ss - часы и секунды удалили
        String currentDateTime = dateFormat.format(calendar.getTime());

        assert currentDateTime.equals("01/01/2023") : "Еще 2022 год :("; //  00:00:00
    ...
    public static void checkingShoppingCart() {
        ...
        productCategories.add("drinks"); // добавляем новую категорию напитки
    ...
    public static void expectedValue() {
        // assertThat(5).isEqualTo(sum(2, 3)); - неправильный вариант
        assertThat(sum(2, 3)).isEqualTo(5); // корректный синтаксис выражения
    }
    ...
    public static void checkingHero() {
        ...
        */
        ...
        //в разработке, как правило, не тестируются Геттеры и Сеттеры, т.к. это слишком простые методы
